    ...
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-4 bg-transparent sm:px-8 sm:py-6">
      <div className="flex items-center gap-2">
        <Link to="/" className="flex items-center gap-2 group">
          <img src="/logo.png" alt="next-editor logo" className="object-contain group-hover:scale-105 transition-transform size-9 sm:size-10" />
          <span className="text-base sm:text-xl leading-none font-machina tracking-tight whitespace-nowrap">next-editor</span>
        </Link>
      </div>
