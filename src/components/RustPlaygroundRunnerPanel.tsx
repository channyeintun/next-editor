...
// the rest, leave raw program output undecorated. Only the tags the Rust
...
function decorateRustConsoleLine(line: string): string {
  const prefixMatch = line.match(RUST_CONSOLE_TAG_PATTERN);
          ...
          <div className="flex min-h-15.5 items-center justify-between border-b border-[#11151d] bg-[#191d25] px-4 py-3">
            ...
            <div className="ml-4 flex items-center gap-2">
              <button
                type="button"
                onClick={() => {
                  clearRunnerConsole(runtimePanelStore, RUST_CONSOLE_SCROLL_SURFACE);
                }}
