  ...
  return (
    <div className="relative flex items-center justify-center overflow-visible size-6">
      ...
      >
        ...
        />
        <path
          d="M6.3 25.5c.8.3 1.7.5 2.7.5h5.5"
          fill="none"
          opacity="0.28"
          stroke="#fff1dd"
          strokeLinecap="round"
        ...
        />
        <path
          d="M12.4 15c1.4-1.3 3.1-1.9 4.9-1.9 1.9 0 3.7.7 5.1 2.1"
          fill="none"
          opacity="0.4"
          stroke="#fff4dd"
          strokeLinecap="round"
        ...
        />
        <path d="M14.7 12.2h5.1l-1.1 4.5h-2.9l-1.1-4.5Z" fill="#fff8ef" opacity="0.97" />
        <path
          d="M11.8 18.3c1.2-.9 2.6-1.4 4.2-1.4"
          fill="none"
          opacity="0.15"
          stroke="#6e3f1b"
          strokeLinecap="round"
        ...
        />
        <path
          d="M22.8 18.3c-1.2-.9-2.6-1.4-4.2-1.4"
          fill="none"
          opacity="0.15"
          stroke="#6e3f1b"
          strokeLinecap="round"
        ...
        />
        <path
          d="M15 19.1c.8-.7 1.7-1 2.7-1s2 .3 2.7 1"
          fill="none"
          opacity="0.22"
          stroke="#6e3f1b"
          strokeLinecap="round"
        ...
        />
        <path
          d="M15.8 21.2c.2-.8.9-1.3 1.8-1.3.8 0 1.6.5 1.9 1.3-.2 1-.9 1.6-1.9 1.6-.9 0-1.7-.6-1.8-1.6Z"
          fill="#2b1e1a"
        />
        <path
          d="M17.7 22.6v1"
        ...
        />
        <path
          d="M16.2 23.7c.4.5 1 .8 1.5.8.6 0 1.1-.3 1.6-.8"
          fill="none"
          stroke="#2b1e1a"
          strokeLinecap="round"
          strokeWidth="0.95"
        />
        <path
          d="M11.5 23.1c-.9.3-1.8.8-2.4 1.6"
          fill="none"
          opacity="0.55"
          stroke="#fff7ea"
          strokeLinecap="round"
        ...
        />
        <path
          d="M23.9 23.1c.9.3 1.8.8 2.4 1.6"
          fill="none"
          opacity="0.55"
          stroke="#fff7ea"
          strokeLinecap="round"
