...
// Reconciles a full-document HTML snapshot into the iframe in place (used by the
// static workspace preview and the runtime snapshot fallback). The rrweb runtime
// replay path does NOT use this — it rebuilds from recorded rrweb events.
