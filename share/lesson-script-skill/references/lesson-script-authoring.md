...
SVG into the plan; the import step verifies the page ids and lists valid
ones on a mismatch:
...
`examples/rust-borrow.yaml` (bundled beside this document) is the canonical example. Start from a copy of it.
